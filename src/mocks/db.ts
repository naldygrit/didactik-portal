...
export const productionCompanies: MockCompany[] = [
  ...
  { id: 4, name: 'Judith Audu Productions', country: countries[0], verification_status: 'verified', notes: '', created_at: '2025-11-05T09:00:00Z', updated_at: '2026-02-10T09:00:00Z' },
  { id: 5, name: 'LowlaDee Productions', country: countries[0], verification_status: 'verified', notes: '', created_at: '2025-11-20T09:00:00Z', updated_at: '2026-02-15T09:00:00Z' },
  { id: 6, name: 'Uyoyou Adia', country: countries[0], verification_status: 'verified', notes: '', created_at: '2026-01-08T09:00:00Z', updated_at: '2026-03-01T09:00:00Z' },
];
...
export const titles: Title[] = [
  ...
  },
  {
    ...
    production_company: { id: 5, name: 'LowlaDee Productions' },
    production_year: 2025,
    country_of_origin: tCountry('KE', 'Kenya', 2),
    co_production_countries: [],
    original_language: tLang('swa', 'Swahili', 5),
  ...
  // there, since that array feeds the admin org list, a separate concern.
  {
    ...
    title_type: 'feature_film',
    production_company: { id: 6, name: 'Uyoyou Adia' },
    production_year: 2026,
    country_of_origin: tCountry('NG', 'Nigeria', 1),
    co_production_countries: [],
    original_language: tLang('yor', 'Yoruba', 1),
  ...
  },
  {
    ...
    production_company: { id: 4, name: 'Judith Audu Productions' },
    production_year: 2026,
    country_of_origin: tCountry('NG', 'Nigeria', 1),
    co_production_countries: [],
